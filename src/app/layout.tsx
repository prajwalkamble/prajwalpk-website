...
export const metadata: Metadata = {
  title: "Prajwal Kamble",
  description:
    "Prajwal Kamble is a passionate and proficient Full Stack Developer from India, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
