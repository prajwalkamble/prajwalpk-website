      ...
      <ConstrainedBox classNames="px-4 py-8 pt-16 z-20 items-center justify-center">
        <Column classNames="w-full items-center justify-center">
          <div className="inline-flex items-center">
            ...
            <FlipWords
              words={["Prajwal Kamble.", "@prajwalkamble."]}
        ...
        <div className="mt-12 lg:mt-16 w-full flex flex-col items-center">
          <p className="text-lg font-medium">Follow me here</p>

          <Row classNames="mt-2 gap-2 items-center justify-center w-full md:w-auto">
